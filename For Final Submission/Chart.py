 ...
 *	Chart.py Park 
 *	
 *	This python script file is a test to implement a qBargraph.
 *	Originally a c++ file, changes have been made to run on python.
 *  Values will later be obtained from the database.
 */
