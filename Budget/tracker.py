...
#                    map_res = map(row0[1], row0[2])
                    ...
                    # print(thisdict)
# print(thisdict.get("netflix"))
date = 112022
val = (1, thisdict.get("open.spotify"), thisdict.get("music.apple"), date, thisdict.get("netflix"))
print(val)
# cur.execute("INSERT INTO customer_purchases (customer_id, spotify, apple_music, sub_date, netflix) VALUES ((%s), (%s), (%s), (%s), (%s));", val)
# db.commit()
...
cur.execute("INSERT INTO subscriptions (customer_id, spotify, apple_music, sub_date, netflix) VALUES ((%s), (%s), (%s), (%s), (%s));", val)
# cur.execute("SELECT * FROM subscriptions ;")
# cur.execute("DELETE FROM subscriptions WHERE sub_date='112022' ;")
cur.execute("SELECT * FROM subscriptions ;")
print(cur.fetchall())
db.commit()
